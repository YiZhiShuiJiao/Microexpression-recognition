...
# 数据参数
MODEL_DIR = 'C:/Users/asus/Desktop/Study/flower/inception_v3/models'  # inception-v3模型文件夹
MODEL_FILE = 'tensorflow_inception_graph.pb'  # inception-v3模型文件名
CACHE_DIR = 'C:/Users/asus/Desktop/Study/flower/inception_v3/bottleneck'  # 图像的特征向量保存地址
INPUT_DATA = 'C:/Users/asus/Desktop/Study/flower/flower_photos' #数据集的路径
...
def main(_):
    ...
    with tf.Session(graph=graph) as sess:
        ...
        # 模型和摘要的保存目录
        # import time
        # timestamp = str(int(time.time()))#是根据时间来命名的
        timestamp = str(int(1557125558)) #改成自己qq号，以防每次都要改test.py里面checkpoint_dir的路径
